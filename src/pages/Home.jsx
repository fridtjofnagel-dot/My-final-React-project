...
function Home () {
        ...
        <a href="#" className="hover-3d my-12 mx-2 cursor-pointer">
            ...
            <div className="card-body">
                ...
                <div className="font-bold">Funny Card</div>
                <div className="text-5xl opacity-10">❁</div>
                </div>
                <div className="text-lg mb-4 opacity-40">This is a funny Testpage</div>
                <div className="flex justify-between">
                <div>
                    <div className="text-xs opacity-20">WebDev</div>
                    <div>Fridtjof N.</div>
                </div>
                <div>
                    <div className="text-xs opacity-20">Born</div>
                    <div>Too old for this s***</div>
                </div>
                </div>
            </div>
            </div>
